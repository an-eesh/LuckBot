                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#men">Lucky Draw</a></li>
                            
                            <li class="submenu">
                                <a href="javascript:;">My Orders</a>
                                <ul>
                                    <li><a href="?neworders=1">New Orders</a></li>
            ...
            <div class="row">
                <div class="col-lg-6">
                  ...
                  <table border="1" cellpadding="10" cellspacing="10" >
                    <tr>
                       <th colspan="9"><font size="4" color="red">My order</font></th>
                    </tr>
                    <tr>
                       <th>Product Name</th>
                       <th>Price</th>
                  ...
                  <?php
                        $uid=$_GET['uid'];
                        $status="N";
                        $sql='SELECT products.pname,orders.prize,categories.category,colors.color,sizes.size,orders.quantity,orders.odate,orders.eddate,products.photo FROM orders LEFT JOIN products ON orders.pid=products.pid LEFT JOIN categories ON orders.cid=categories.cid LEFT JOIN colors ON orders.clrid=colors.clrid LEFT JOIN sizes ON orders.siid=sizes.siid where orders.uid="'.$uid.'" AND status="'.$status.'"';
                        $result=$conn->query($sql);
                        $slno;
                        $slno=1;
