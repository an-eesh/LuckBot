 ...
 <br>
                ...
                <tr>
                    <td>
                      ...
                      <?php
                            $uid=$_GET['uid'];
                            $status="N";
                            $sql='SELECT winner.*, luckbotproducts.name AS pname,luckbotproducts.photo,luckbotorderaddress.oaid FROM winner LEFT JOIN luckbotorderaddress ON luckbotorderaddress.lkoid= winner.lkoid LEFT JOIN luckbotproducts ON luckbotproducts.lkpid=winner.lkpid where winner.uid='.$uid;
                            $result=$conn->query($sql);
                            $slno;
                            $slno=1;
   ...
   $pname=$row['pname'];
                              ...
                              <tr>
                               ...
                               <td><?=$name?></td>
                               <td><?=$pname?></td>
                               <td><img src="assets\images\LUCKBOT_PRODUCTS\<?=$photo?>" height="150" width="150"></td>
                              </tr>
                              <?php
                              $slno++;
                            }
