        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <p class="text-center">Sign in by entering the information below</p>
                    <form action="doaction.php?login=1" method="POST" class="login-form">
                    <?php
                    if(isset($_REQUEST['message']))
                    {
                    $msg=$_REQUEST['message'];
                    //echo'<tr><td colspan="13" style="color:#FF0000" align="center">'.$msg.'</td></tr>';-->
                    echo '<div class="form-group">
                        <div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-user">'.$msg.'</span></div>';
                    }
                    ?>    
