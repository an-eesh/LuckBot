...
{
  echo'<tr><td colspan="19" style="color:darkred;">'.$_REQUEST['message'].'</td></tr>';
}
...
?>
  ...
  <tr>
    <th colspan="19"><font size="4" color="red">New Orders From Customers</font></th>
  </tr>
  ...
  while($row=mysqli_fetch_array($result))
        {
          ...
          ?>
            ...
            <tr>
              ...
              <td><?=$pin?></td>
              <td><?=$landmark?></td>
              <td><b><a href="doaction.php?deliver=1&oid=<?=$oid?>" style="background-color:darkgreen;color:white;">&nbsp;DELIVER</a></b></td>
            </tr>
    <?php
      $slno++;
      }
