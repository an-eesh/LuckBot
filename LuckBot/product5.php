...
<?php
	$sql='SELECT luckbotproducts.name,luckbotorders.lkoid,luckbotproducts.price,companies.company,categories.category,colors.color,sizes.size from luckbotorders LEFT JOIN luckbotproducts ON luckbotproducts.lkpid=luckbotorders.lkpid LEFT JOIN companies ON companies.comid=luckbotproducts.comid LEFT JOIN categories ON categories.cid=luckbotproducts.cid LEFT JOIN colors ON luckbotproducts.clrid=colors.clrid LEFT JOIN sizes ON luckbotproducts.siid=sizes.siid where luckbotproducts.lkpid="5"';
