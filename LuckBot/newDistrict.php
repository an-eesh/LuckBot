...
<html>
  <head>
   ...
   <body>
   <form action="doaction.php?addDistrict=1" method="POST"> 
         ...
         ?>
                           ...
                           <tr>
                           <td colspan="2" align="center" cellspacing="30" ><b><font size="5" color="#6f1cf4">Add District</font></b></td>
                           </tr>

                           <tr>
                           <td><label>Select State:</label></td>
                           <td><select class="input--style-3" type="text" placeholder="State" name="sid" id="sid"  onChange="getpanchayath();">
				...
				?>
				                 ...
				                 <tr>
				                 	<td><label>New District:</label></td>
				                 	<td>
